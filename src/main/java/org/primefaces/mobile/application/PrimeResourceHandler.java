...
public class PrimeResourceHandler extends ResourceHandlerWrapper {
    ...
    public void handleResourceRequest(FacesContext context) throws IOException {
        ...
        String dynamicContentId = (String) params.get(org.primefaces.util.Constants.DYNAMIC_CONTENT_PARAM);
        String nocache = params.get(org.primefaces.util.Constants.DYNAMIC_CONTENT_NOCACHE_PARAM);
